...
const defaultConfig = {
  SESSION_ID: "1I0EUSIB#gzEiTi8yWhNsX6IcNzVDXkpMHXYr1ZL-ufhDuV_9f1o", // Put your session id here
  ALIVE_IMG: "https://github.com/DANUWA-MD/DANUWA-BOT/blob/main/images/Danuwa%20-%20MD.png?raw=true",
  ALIVE_MSG: "*Hello👋 HEXA CHAOS Is Alive Now😍*", // Change alive msg from here
  OPENAI_API_KEY: "",// Add OPENAI API key here
  GEMINI_API_KEY: "AIzaSyC_Qwui6A5SST_k0lXj-H0hfcRq3bHgYRw", // Add Gemini API key here
  REMOVE_BG_API_KEY:"", // Add removebg API key here
  WEATHER_API_KEY: "", // Add your weather API key here
  BOT_OWNER: "94721764854", // Replace your bot owner number here with 94(country code)
  ownerNumber: ["94721764854"], // Replace your bot owner number here (same as bot owner number)
